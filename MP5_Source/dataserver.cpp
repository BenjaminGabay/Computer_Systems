...
{
  if (argc != 3) //Valid number of command line arguments
    {
        std::cout << "USAGE: " << argv[0] << " -p -b" << std::endl;
        std::cout << "\t-p <port number for data server>" << std::endl;
        std::cout << "\t-b <backlog of the server socket>" << std::endl;
        return 1;
    }
