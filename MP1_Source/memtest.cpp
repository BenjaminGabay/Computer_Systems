...
int main(int argc, char * argv[]) {
  ...
  {
	  cout << "ERROR" << endl;
	  cout << "Usage: " << argv[0] << " <memory block size> <number of blocks>" << endl;
	  return 1;
  }
  size_t block_size = stoi(argv[1]); //Enter 1024 in cmd line
  size_t mem_size = stoi(argv[2]) * block_size; //Enter 1024 in cmd line
